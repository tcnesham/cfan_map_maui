...
using CFAN.SchoolMap.Maui.GoogleMaps.Helpers;
using System.Threading.Tasks;
using CFAN.SchoolMap.Maui.GoogleMaps.Extensions;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public static readonly BindableProperty VisibleRegionProperty = BindableProperty.Create(
            nameof(VisibleRegion), typeof(MapSpan), typeof(Map),
            default(MapSpan),
            defaultBindingMode: BindingMode.TwoWay);
        ...
        public event EventHandler<PinClickedEventArgs> PinDoubleClicked;
        ...
        public bool SendPinDoubleClicked(Pin pin)
        {
            var args = new PinClickedEventArgs(pin);
            PinDoubleClicked?.Invoke(this, args);
            return args.Handled;
        }

        public bool SendPoiClicked(Poi poi)
        {
            var args = new PoiClickedEventArgs(poi);
            PoiClicked?.Invoke(this, args);
            return args.Handled;
        }
