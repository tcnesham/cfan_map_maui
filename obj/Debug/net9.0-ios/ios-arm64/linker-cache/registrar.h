...
@class GMSOverlay;
@class GMSMarker;
@class GMSAdvancedMarker;
@class GMSCameraPosition;
@class GMSCameraUpdate;
@class GMSCircle;
@class GMSCoordinateBounds;
// Google.Maps.VisibleRegion (+other structs with same layout)
...
@protocol GMSFeature;
@class GMSDatasetFeature;
@class GMSFeatureLayer;
@class GMSDatasetFeatureLayer;
@class ApiDefinition__Google_Maps_Feature;
...
@class ApiDefinition__Google_Maps_IndoorDisplayDelegate;
...
@class ApiDefinition__Google_Maps_MapViewDelegate;
@class GMSMapViewOptions;
@class GMSOverlayLayer;
@class GMSMarkerLayer;
@class GMSMutableCameraPosition;
@class GMSMutableFeatureStyle;
@class GMSPath;
@class GMSMutablePath;
@class GMSPanorama;
@class GMSPanoramaCamera;
// Google.Maps.Orientation (+other structs with same layout)
struct trampoline_struct_dd {
	double v0;
	double v8;
};
@class GMSPanoramaCameraUpdate;
@class GMSPanoramaLayer;
@class GMSPanoramaLink;
@protocol GMSPanoramaViewDelegate;
@class ApiDefinition__Google_Maps_PanoramaViewDelegate;
@class GMSPinImage;
@class GMSPinImageGlyph;
@class GMSPinImageOptions;
@class GMSPlaceFeature;
@class GMSPolygon;
...
@class GMSStampStyle;
@class GMSSpriteStyle;
@class GMSStrokeStyle;
@class GMSStyleSpan;
@class GMSTileLayer;
@class GMSSyncTileLayer;
@class GMSTextureStyle;
@protocol GMSTileReceiver;
@class ApiDefinition__Google_Maps_TileReceiver;
@class GMSUISettings;
@class GMSURLTileLayer;
@class GMSGeocoder;
@class Google_Maps_MapView__MapViewDelegate;
@class UIKit_UIView_UIViewAppearance;
@class Google_Maps_MapView_MapViewAppearance;
@class GMSMapView;
@class GMSPanoramaService;
@class Google_Maps_PanoramaView__PanoramaViewDelegate;
@class Google_Maps_PanoramaView_PanoramaViewAppearance;
...
@class Microsoft_Maui_Maps_Platform_MauiMKMapView;
@class Maui_GoogleMaps_iOS_TouchSyncTileLayer;
@class Maui_GoogleMaps_iOS_TouchAsyncTileLayer;
...
@interface GMSMarker : GMSOverlay {
	...
	-(NSUInteger) appearAnimation;
	-(void) setAppearAnimation:(NSUInteger)p0;
	-(BOOL) isDraggable;
	...
	-(void) setTracksInfoWindowChanges:(BOOL)p0;
	-(BOOL) tracksViewChanges;
	-(void) setTracksViewChanges:(BOOL)p0;
	-(id) init;
@end

@interface GMSAdvancedMarker : GMSMarker {
}
	-(NSInteger) collisionBehavior;
	-(void) setCollisionBehavior:(NSInteger)p0;
	-(id) init;
@end
...
@interface GMSCameraPosition : NSObject {
	...
	-(NSObject *) copyWithZone:(id)p0;
	-(NSObject *) mutableCopyWithZone:(id)p0;
	-(double) bearing;
	...
	-(id) initWithTarget:(CLLocationCoordinate2D)p0 zoom:(float)p1;
	-(id) initWithLatitude:(double)p0 longitude:(double)p1 zoom:(float)p2;
	-(id) initWithLatitude:(double)p0 longitude:(double)p1 zoom:(float)p2 bearing:(double)p3 viewingAngle:(double)p4;
@end
...
@protocol GMSFeature
	@required @property (nonatomic, assign, readonly) NSString * featureType;
@end

@interface GMSDatasetFeature : NSObject {
}
	-(NSDictionary <NSString *, NSString *>*) datasetAttributes;
	-(NSString *) datasetID;
	-(NSString *) featureType;
	-(id) initWithDatasetID:(NSString *)p0 datasetAttributes:(NSDictionary <NSString *, NSString *>*)p1;
@end
...
@interface GMSFeatureLayer : NSObject {
	...
	-(NSString *) featureType;
	-(id) style;
	-(void) setStyle:(void * (^)(void *))p0;
	-(id) initWithFeatureType:(NSString *)p0;
@end
...
@interface ApiDefinition__Google_Maps_Feature : NSObject<GMSFeature> {
}
	-(id) init;
@end
...
@interface GMSFeatureStyle : NSObject {
	...
	-(CGFloat) strokeWidth;
	-(id) init;
	-(id) initWithFillColor:(UIColor *)p0 strokeColor:(UIColor *)p1 strokeWidth:(CGFloat)p2;
@end
...
@protocol GMSIndoorDisplayDelegate
	@optional -(void) didChangeActiveBuilding:(id)p0;
	@optional -(void) didChangeActiveLevel:(id)p0;
@end

@interface ApiDefinition__Google_Maps_IndoorDisplayDelegate : NSObject<GMSIndoorDisplayDelegate> {
}
	-(id) init;
@end
...
@interface GMSMapID : NSObject {
}
	-(NSObject *) copyWithZone:(id)p0;
	-(id) initWithIdentifier:(NSString *)p0;
@end
...
@protocol GMSMapViewDelegate
	@optional -(void) mapView:(id)p0 willMove:(BOOL)p1;
	@optional -(void) mapView:(id)p0 didChangeCameraPosition:(id)p1;
	@optional -(void) mapView:(id)p0 idleAtCameraPosition:(id)p1;
	@optional -(void) mapView:(id)p0 didTapAtCoordinate:(CLLocationCoordinate2D)p1;
	@optional -(void) mapView:(id)p0 didLongPressAtCoordinate:(CLLocationCoordinate2D)p1;
	@optional -(BOOL) mapView:(id)p0 didTapMarker:(id)p1;
	@optional -(void) mapView:(id)p0 didTapInfoWindowOfMarker:(id)p1;
	@optional -(void) mapView:(id)p0 didLongPressInfoWindowOfMarker:(id)p1;
	@optional -(void) mapView:(id)p0 didTapOverlay:(id)p1;
	@optional -(void) mapView:(id)p0 didTapPOIWithPlaceID:(NSString *)p1 name:(NSString *)p2 location:(CLLocationCoordinate2D)p3;
	@optional -(UIView *) mapView:(id)p0 markerInfoWindow:(id)p1;
	@optional -(UIView *) mapView:(id)p0 markerInfoContents:(id)p1;
	@optional -(void) mapView:(id)p0 didCloseInfoWindowOfMarker:(id)p1;
	@optional -(void) mapView:(id)p0 didBeginDraggingMarker:(id)p1;
	@optional -(void) mapView:(id)p0 didEndDraggingMarker:(id)p1;
	@optional -(void) mapView:(id)p0 didDragMarker:(id)p1;
	@optional -(BOOL) didTapMyLocationButtonForMapView:(id)p0;
	@optional -(void) mapView:(id)p0 didTapMyLocation:(CLLocationCoordinate2D)p1;
	@optional -(void) mapViewDidStartTileRendering:(id)p0;
	@optional -(void) mapViewDidFinishTileRendering:(id)p0;
	@optional -(void) mapViewSnapshotReady:(id)p0;
	@optional -(void) mapView:(id)p0 didChangeMapCapabilities:(NSUInteger)p1;
	@optional -(void) mapView:(id)p0 didTapFeatures:(NSArray *)p1 inFeatureLayer:(id)p2 atLocation:(CLLocationCoordinate2D)p3;
@end

@interface ApiDefinition__Google_Maps_MapViewDelegate : NSObject<GMSMapViewDelegate> {
}
	-(id) init;
@end
...
@interface GMSPath : NSObject {
	...
	-(CLLocationCoordinate2D) coordinateAtIndex:(void *)p0;
	-(NSObject *) copyWithZone:(id)p0;
	-(double) lengthOfKind:(NSUInteger)p0;
	-(NSObject *) mutableCopyWithZone:(id)p0;
	-(id) pathOffsetByLatitude:(double)p0 longitude:(double)p1;
	-(double) segmentsForLength:(double)p0 kind:(NSUInteger)p1;
	-(void *) count;
...
@interface GMSMutablePath : GMSPath {
	...
	-(void) insertCoordinate:(CLLocationCoordinate2D)p0 atIndex:(void *)p1;
	-(void) removeAllCoordinates;
	-(void) removeCoordinateAtIndex:(void *)p0;
	-(void) removeLastCoordinate;
	-(void) replaceCoordinateAtIndex:(void *)p0 withCoordinate:(CLLocationCoordinate2D)p1;
	-(id) init;
@end
...
@protocol GMSPanoramaViewDelegate
	@optional -(void) panoramaView:(id)p0 willMoveToPanoramaID:(NSString *)p1;
	@optional -(void) panoramaView:(id)p0 didMoveToPanorama:(id)p1;
	@optional -(void) panoramaView:(id)p0 didMoveToPanorama:(id)p1 nearCoordinate:(CLLocationCoordinate2D)p2;
	@optional -(void) panoramaView:(id)p0 error:(NSError *)p1 onMoveNearCoordinate:(CLLocationCoordinate2D)p2;
	@optional -(void) panoramaView:(id)p0 error:(NSError *)p1 onMoveToPanoramaID:(NSString *)p2;
	@optional -(void) panoramaView:(id)p0 didMoveCamera:(id)p1;
	@optional -(void) panoramaView:(id)p0 didTap:(CGPoint)p1;
	@optional -(BOOL) panoramaView:(id)p0 didTapMarker:(id)p1;
	@optional -(void) panoramaViewDidStartRendering:(id)p0;
	@optional -(void) panoramaViewDidFinishRendering:(id)p0;
@end

@interface ApiDefinition__Google_Maps_PanoramaViewDelegate : NSObject<GMSPanoramaViewDelegate> {
}
	-(id) init;
@end
...
@interface GMSPinImageGlyph : NSObject {
	...
	-(NSString *) text;
	-(UIColor *) textColor;
	-(id) initWithText:(NSString *)p0 textColor:(UIColor *)p1;
	-(id) initWithImage:(UIImage *)p0;
	-(id) initWithGlyphColor:(UIColor *)p0;
@end
...
@interface GMSPlaceFeature : NSObject {
}
	-(NSString *) featureType;
	-(NSString *) placeID;
	-(id) initWithFeatureType:(NSString *)p0 placeID:(NSString *)p1;
@end
...
@interface GMSTileLayer : NSObject {
	...
	-(void) clearTileCache;
	-(void) requestTileForX:(void *)p0 y:(void *)p1 zoom:(void *)p2 receiver:(id)p3;
	-(BOOL) fadeIn;
...
@interface GMSSyncTileLayer : GMSTileLayer {
	...
	-(UIImage *) tileForX:(void *)p0 y:(void *)p1 zoom:(void *)p2;
	-(id) init;
@end
...
@protocol GMSTileReceiver
	@required -(void) receiveTileWithX:(void *)p0 y:(void *)p1 zoom:(void *)p2 image:(UIImage *)p3;
@end

@interface ApiDefinition__Google_Maps_TileReceiver : NSObject<GMSTileReceiver> {
}
	-(id) init;
@end
...
@interface GMSUISettings : NSObject {
	...
	-(void) setAllowScrollGesturesDuringRotateOrZoom:(BOOL)p0;
	-(BOOL) compassButton;
...
@interface GMSGeocoder : NSObject {
	...
	-(void) reverseGeocodeCoordinate:(CLLocationCoordinate2D)p0 completionHandler:(void (^)(id, id))p1;
	-(id) init;
@end
...
@interface Google_Maps_MapView_MapViewAppearance : UIKit_UIView_UIViewAppearance {
}
@end
...
@interface GMSMapView : UIView {
	...
	-(void) clear;
	-(id) datasetFeatureLayerOfDatasetID:(NSString *)p0;
	-(BOOL) areEqualForRenderingPosition:(id)p0 position:(id)p1;
	-(id) featureLayerOfFeatureType:(NSString *)p0;
	...
	-(id) camera;
	-(void) setCamera:(id)p0;
	-(id) cameraTargetBounds;
	-(void) setCameraTargetBounds:(id)p0;
	-(id) delegate;
	-(void) setDelegate:(id)p0;
	-(id) indoorDisplay;
	...
	-(id) layer;
	-(NSUInteger) mapCapabilities;
	-(id) mapStyle;
	-(void) setMapStyle:(id)p0;
	-(NSUInteger) mapType;
	...
	-(void) setOverrideUserInterfaceStyle:(NSInteger)p0;
	-(UIEdgeInsets) padding;
	-(void) setPadding:(UIEdgeInsets)p0;
	-(NSUInteger) paddingAdjustmentBehavior;
	-(void) setPaddingAdjustmentBehavior:(NSUInteger)p0;
	-(NSUInteger) preferredFrameRate;
	-(void) setPreferredFrameRate:(NSUInteger)p0;
	-(id) projection;
	-(id) selectedMarker;
	...
	-(id) init;
	-(id) initWithCoder:(NSCoder *)p0;
	-(id) initWithOptions:(id)p0;
	-(id) initWithFrame:(CGRect)p0;
	-(id) initWithFrame:(CGRect)p0 camera:(id)p1;
	-(id) initWithFrame:(CGRect)p0 mapID:(id)p1 camera:(id)p2;
@end

@interface GMSPanoramaService : NSObject {
}
	-(void) requestPanoramaNearCoordinate:(CLLocationCoordinate2D)p0 callback:(void (^)(id, id))p1;
	-(void) requestPanoramaNearCoordinate:(CLLocationCoordinate2D)p0 radius:(void *)p1 callback:(void (^)(id, id))p2;
	-(void) requestPanoramaNearCoordinate:(CLLocationCoordinate2D)p0 source:(NSUInteger)p1 callback:(void (^)(id, id))p2;
	-(void) requestPanoramaNearCoordinate:(CLLocationCoordinate2D)p0 radius:(void *)p1 source:(NSUInteger)p2 callback:(void (^)(id, id))p3;
	-(void) requestPanoramaWithID:(NSString *)p0 callback:(void (^)(id, id))p1;
	-(id) init;
@end

@interface Google_Maps_PanoramaView_PanoramaViewAppearance : UIKit_UIView_UIViewAppearance {
}
@end
...
@interface GMSPanoramaView : UIView {
	...
	-(void) moveNearCoordinate:(CLLocationCoordinate2D)p0 radius:(void *)p1;
	-(void) moveNearCoordinate:(CLLocationCoordinate2D)p0 source:(NSUInteger)p1;
	-(void) moveNearCoordinate:(CLLocationCoordinate2D)p0 radius:(void *)p1 source:(NSUInteger)p2;
...
@interface Microsoft_Maui_Maps_Platform_MauiMKMapView : MKMapView {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
