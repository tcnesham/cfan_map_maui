...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Square.OkHttp.Call+ActionCallback, Square.OkHttp", Call_ActionCallback.class, __md_methods);
	}
	...
	public Call_ActionCallback ()
	{
		...
		if (getClass () == Call_ActionCallback.class) {
			mono.android.TypeManager.Activate ("Square.OkHttp.Call+ActionCallback, Square.OkHttp", "", this, new java.lang.Object[] {  });
		}
	}
