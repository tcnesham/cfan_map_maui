...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.CloudFirestore.OnCompleteHandlerListener, Plugin.CloudFirestore", OnCompleteHandlerListener.class, __md_methods);
	}
	...
	public OnCompleteHandlerListener ()
	{
		...
		if (getClass () == OnCompleteHandlerListener.class) {
			mono.android.TypeManager.Activate ("Plugin.CloudFirestore.OnCompleteHandlerListener, Plugin.CloudFirestore", "", this, new java.lang.Object[] {  });
		}
	}
