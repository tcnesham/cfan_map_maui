...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Maui.GoogleMaps.Android.Callbacks.DelegateSnapshotReadyCallback, Maui.GoogleMaps", DelegateSnapshotReadyCallback.class, __md_methods);
	}
	...
	public DelegateSnapshotReadyCallback ()
	{
		...
		if (getClass () == DelegateSnapshotReadyCallback.class) {
			mono.android.TypeManager.Activate ("Maui.GoogleMaps.Android.Callbacks.DelegateSnapshotReadyCallback, Maui.GoogleMaps", "", this, new java.lang.Object[] {  });
		}
	}
